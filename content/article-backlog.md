# Article Backlog — winfredquek.com

**Workflow:** Winfred vets this list → picks 3 articles/day → sends to overnight builds. No mass dumps (sudden bulk publishing can read as a low-quality content dump to Google and hurt rankings — steady cadence is safer).

**Status legend:** `[ ]` not started · `[~]` in build · `[x]` published · `[-]` rejected

**Rules for every article (already baked into the build template):**
- Bank mortgage rate = ~1.5% (2026). HDB loan 2.6%, CPF OA 2.5%, TDSR floor 4% — do not confuse.
- Real, sourced numbers only. No estimated/fabricated data. If a figure can't be sourced to IRAS/MAS/HDB/CPF Board/URA, leave it out.
- Author: Winfred Quek, Associate Marketing Consultant · CEA R073319H · Crestbrick Pte Ltd (L31010886H).

...
(function(){
  ...
  // ============================================================
  // #280 Exit-intent capture (offer free 4-pillar eBook)
  // ============================================================
  function initExitIntent() {
    ...
    document.addEventListener('mouseleave', (e) => {
      ...
      overlay.innerHTML = `<div style="background:#1a1610;border:1px solid rgba(180,140,80,0.3);border-radius:12px;padding:32px;max-width:440px;color:#f0e9d8;text-align:center;font-family:-apple-system,system-ui,sans-serif;">
        ...
        <p style="color:#a89980;margin-bottom:20px;line-height:1.6;font-size:15px;">Free 4-Pillar Framework eBook. The way I diagnose every Singapore property situation. No fluff.</p>

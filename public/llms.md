...
Singapore-wide. Concentrations in Bishan, Toa Payoh, East Coast, Punggol/Sengkang, Bukit Timah. Foreign clients from US, UK, China, India, FTA-exempt jurisdictions (Switzerland, Liechtenstein, Iceland, Norway).
...
Standard CEA-licensed real estate commission for buyer / seller representation. Pure advisory engagements (family offices, pre-purchase research, decoupling planning) have a transparent flat-fee option. See <https://winfredquek.com/pricing>.

### What Winfred does **not** do

- Commercial / industrial leasing (residential focus).
- Legal conveyancing.
- Mortgage broking (refers to independent brokers).
- Tax filing (CPA referrals only).
...
**Math:**
- Transferring 50% share: BSD on S$1M ≈ S$24,600.
- Buying second at S$1.8M, zero-property spouse: avoids 20% ABSD = S$360,000.
- **Net saving: ~S$335,000.**

**Caveats:** Lender approval for buyout. CPF refund on transferred share. Stamp duty timing. Math only works if buying spouse qualifies for financing solo.

---

## Stamp duty reference (2026)

### ABSD rates (effective 27 April 2023, unchanged through 2026)
...
- [HDB MOP to condo upgrade timeline](https://winfredquek.com/insights/hdb-mop-upgrade-timeline)
- [Singapore cooling measures timeline](https://winfredquek.com/insights/cooling-measures)
- [TDSR stress test explained](https://winfredquek.com/insights/tdsr-stress-test-explained)

---

## Contact

- **WhatsApp / phone:** +65 8161 8149 (fastest)
